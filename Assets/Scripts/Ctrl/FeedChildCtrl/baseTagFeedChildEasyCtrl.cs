...
public class BaseTagFeedChildEasyCtrl : MonoBehaviour, IController
{
    //View
    [SerializeField]
    public Image ImgShow, ImgProgress;
    [SerializeField]
    TextMeshProUGUI TextDesc, TxtProgress;
    ...
    public string ImgShowPath = "Sprite/Child/ChildEasyShow/";
    ...
    virtual public void GetCoponent()
    {
        ...
        Btn1 = Btn_2_1.transform.GetComponent<Image>();
        Btn2 = Btn_2_2.transform.GetComponent<Image>(); 
    ...
    virtual async public void RefreshUI(bool textRefresh = false)
    {
        ...
        else
        {
            ...
            if(m_Model.level < 1)
            {
                ImgShow.sprite = ResourceManager.Instance.Load<Sprite>(ImgShowPath, "1");
            }
            else if(m_Model.level < 2)
            {
                ImgShow.sprite = ResourceManager.Instance.Load<Sprite>(ImgShowPath, "2");
            }
            else if(m_Model.level < 3)
            {
                ImgShow.sprite = ResourceManager.Instance.Load<Sprite>(ImgShowPath, "3");
            }
            else if(m_Model.level < 4)
            {
                ImgShow.sprite = ResourceManager.Instance.Load<Sprite>(ImgShowPath, "4");
            }
            else if(m_Model.level < 6)
            {
                ImgShow.sprite = ResourceManager.Instance.Load<Sprite>(ImgShowPath, "5");
            }
            else if(m_Model.level < 8)
            {
                ImgShow.sprite = ResourceManager.Instance.Load<Sprite>(ImgShowPath, "6");
            }
        }
