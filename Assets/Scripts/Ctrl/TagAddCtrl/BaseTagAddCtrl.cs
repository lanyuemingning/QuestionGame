...
public class BaseTagAddCtrl : MonoBehaviour, IController
{
    //View
    [SerializeField]
    ...
    virtual public void SetPanelOnClick()
    {
        ...
        {
            this.SendCommand<SelectTagAddNextCommand>();
        });
    ...
    {
        nowSelect = 1;
        this.SendCommand<FirstTagAddCommand>();
    }

    virtual public void SelectTwo()
    {
        nowSelect = 2;
        this.SendCommand<SecondTagAddCommand>();
    }
    virtual public void SelectThree()
    {
        nowSelect = 3;
        this.SendCommand<ThirdTagAddCommand>();
    }
    virtual public void SelectFour()
    {
        nowSelect = 4;
        this.SendCommand<FourthTagAddCommand>();
    }
