...
public class ResourceManager : MonoSingleton<ResourceManager>, ICanGetUtility, ICanSendEvent
{
    ...
    public void LoadFont()
    {
        ...
        UILoadingCtrl.Instance.ImgLoading.DOFillAmount(0.7f, 0.5f)
            .SetEase(Ease.Linear)
            .OnComplete(() =>
            {
                UILoadingCtrl.Instance.ImgLoading.DOFillAmount(0.9f, 0.5f)
                   .SetEase(Ease.Linear)
                   .OnComplete(() =>
                   {
                       this.GetUtility<UIUtility>().OpenUI("UIStart");
                   });
            });
